...
export function useCaptionGeneratorPersistence(state: CaptionGeneratorState) {
  useEffect(() => {
    try {
      restoreCreatePostState({
        ...
        setLastAutoGenerateTopicHint: state.setLastAutoGenerateTopicHint,
        setLastGeneratePostTopicHint: state.setLastGeneratePostTopicHint,
  ...
  useEffect(() => {
    ...
    const payload: CreatePostPersistedState = {
      ...
      lastAutoGenerateTopicHint: state.lastAutoGenerateTopicHint,
      lastGeneratePostTopicHint: state.lastGeneratePostTopicHint,
    ...
    state.topic,
    state.message,
    state.lastAutoGenerateTopicHint,
    state.lastGeneratePostTopicHint,
    state.postType,
