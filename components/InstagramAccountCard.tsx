  ...
  return (
    <Panel className="p-6">
      ...
      <div className="mt-6 grid gap-3 rounded-2xl bg-slate-50 p-4 text-sm text-slate-700">
        <p>
          <span className="font-semibold text-ink">{dictionary.instagramCard.username}:</span> {username}
        </p>
        <p>
          <span className="font-semibold text-ink">{dictionary.instagramCard.instagramId}:</span> {instagramUserId}
        </p>
        <p>
