...
export function AgendaAutomationSection(props: Pick<AgendaSectionsProps, "dictionary" | "saveSettings" | "generateWeeklyAgenda" | "isSaving" | "isGenerating" | "currentTopics">) {
