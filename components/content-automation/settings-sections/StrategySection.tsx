        ...
        <div className="grid gap-6 lg:grid-cols-[1.2fr_0.8fr]">
          <div className="space-y-5">
            ...
            <BrandColorsEditor
              ...
              setBrandColors={props.setBrandColors}
              brandColorsHistory={props.brandColorsHistory}
              saveBrandColorsToHistory={props.saveBrandColorsToHistory}
              removeBrandColorsFromHistory={props.removeBrandColorsFromHistory}
            />
