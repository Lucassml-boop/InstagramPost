  ...
  const groupedAgenda = useMemo(() => {
    const groups = automation.agenda.reduce((map, item) => {
      ...
      if (current) {
        ...
        map.set(key, { ...item, expectedPostsCount, expectedTimes, expectedIdeas, items: [item], extraPosts: [] });
      }
      return map;
    }, new Map<string, any>());
